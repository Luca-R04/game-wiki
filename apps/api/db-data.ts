...
export const GAMES: any = {
  ...
  3: {
    ...
    releaseDate: new Date('2022-09-11'),
    image:
      'https://image.api.playstation.com/vulcan/ap/rnd/202107/3100/YuD3gr8HlMcHEUi4MtuHTvx5.jpg',
    positivePercent: 90,
    description:
  ...
  4: {
    ...
    releaseDate: new Date('2022-09-11'),
    image:
      'https://media.cdnandroid.com/item_images/31781/imagen-candy-crush-saga-13ori.jpg',
    positivePercent: 90,
    description:
  ...
  5: {
    ...
    releaseDate: new Date('2022-09-11'),
    image:
      'https://cdn1.epicgames.com/offer/50bbaf85f4454b1c88786efeede5b302/EGS_GoatSimulator3_CoffeeStainNorthAB_S2_1200x1600-99737fa8a749438ca909c776a4cd9b89',
    positivePercent: 90,
    description:
  ...
  7: {
    ...
    releaseDate: new Date('2022-09-11'),
    image:
      'https://cdn.cdkeys.com/500x706/media/catalog/product/e/l/elden_ring_xbox_one_xbox_series_x_s_uk_1_.jpg',
    positivePercent: 90,
    description:
  ...
  8: {
    ...
    releaseDate: new Date('2022-09-11'),
    image:
      'https://www.a90skid.com/wp-content/uploads/2021/10/deathloop-cover-art.jpg',
    positivePercent: 90,
    description:
  ...
  9: {
    ...
    releaseDate: new Date('2022-09-11'),
    image:
      'https://media.contentapi.ea.com/content/dam/eacom/a-way-out/common/a-way-out-origin-packart.jpg',
    positivePercent: 90,
    description:
  ...
  10: {
    ...
    category: 'Adventure',
    releaseDate: new Date('2022-09-11'),
    image: 'https://vgboxart.com/boxes/MISC/76446-cuphead.png',
    positivePercent: 90,
    description:
